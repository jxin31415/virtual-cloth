...
We'll omit discussion of rendering as it is not the focus of our project. For the floor, we use the same rendering process as menger sponge, and for the sphere, we use and adapt some reference code taken from Github (https://github.com/ndesmic/geogl/blob/v3/js/lib/shape-gen.js).
...
blah blah blah
Additionally, self-collisions could use some work, as it is hard to model accurately with a limited computational budget. 
